...
The example provided commenting/uncommenting line 25 shows the difference of context switching
Without pause
-------------
Without the pause, the final Counter value = 4
This is because, before the second routine is executed , routine 1 loop has already completed
